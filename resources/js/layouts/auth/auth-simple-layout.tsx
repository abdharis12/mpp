...
export default function AuthSimpleLayout({
    ...
    return (
        <>
            ...
            <div className="bg-background text-foreground flex min-h-screen flex-col font-['Poppins',_sans-serif]">
                {/* signage strip */}
                <div
                ...
                <header className="border-border border-b">
                    <div className="mx-auto flex h-16 w-full max-w-6xl items-center justify-between gap-4 px-6 lg:px-8">
                        ...
                        <Link
                            href={home()}
                            className="text-muted-foreground hover:text-foreground transition-color text-sm"
                        >
                            Kembali
                        </Link>
                    </div>
                    ...
                    <div className="mx-auto grid w-full max-w-6xl items-stretch gap-10 px-6 py-16 lg:grid-cols-[1.05fr_0.95fr] lg:gap-14 lg:px-8 lg:py-24">
                        ...
                        <div className="flex flex-col justify-center">
                            <div className="max-w-md">
                                <h1 className="font-['Poppins',_sans-serif] text-3xl leading-[1.1] font-bold tracking-tight sm:text-4xl">
                                    {title}
                                </h1>
                                {description && (
                        ...
                        >
                            <div>
                                ...
                                <p className="mt-4 text-sm leading-relaxed text-white/70">
                                    Satu atap untuk layanan publik. Masuk untuk
                                    mengakses sistem absensi dan monitoring
                                    petugas.
                                </p>
                            </div>
                            ...
                            <div className="mt-8 border-t border-white/15 pt-6">
                                ...
                                <p className="mt-4 text-xs leading-relaxed text-white/45">
                                    ...
                                    masuk. Hubungi admin jika belum memiliki
                                    akses.
                                </p>
                            </div>
                        </div>
                ...
                >
                    ...
                    <div className="mx-auto w-full max-w-6xl px-6 py-12 lg:px-8">
                        ...
                        <div className="mt-10 flex flex-col gap-2 border-t border-white/15 pt-6 text-xs text-white/50 sm:flex-row sm:items-center sm:justify-between">
                            <p>
                                © 2026 Mal Pelayanan Publik Kabupaten Muara
                                Enim.
                            </p>
                            <p>
                                Sistem absensi petugas berada di dalam (login).
                            </p>
                        </div>
                    </div>
                </footer>
